...
#define IDENT_VENDOR_STRING2     "YD"
#define IDENT_PRODUCT_NUM       1503
#define IDENT_PRODUCT_STRING    "HIDBoot"
#define IDENT_PRODUCT_STRING2    "YDBL"

#ifndef BOOTLOAD_SIZE
#define BOOTLOAD_SIZE           1024
#endif
...
union{
    ...
    if((err = usbOpenDevice(&dev, IDENT_VENDOR_NUM, IDENT_VENDOR_STRING, IDENT_PRODUCT_NUM, IDENT_PRODUCT_STRING, 1)) != 0){
        if((err = usbOpenDevice(&dev, IDENT_VENDOR_NUM, IDENT_VENDOR_STRING2, IDENT_PRODUCT_NUM, IDENT_PRODUCT_STRING2, 1)) != 0) {
